...
def test_fragment_pipeline_artifacts_are_present():
    ...
    for path in [
        ...
        root / "configs" / "fs_diloco_gpt2_wikitext2_8l_fragment_50x10.yaml",
        root / "configs" / "fs_diloco_gpt2_wikitext2_8l_no_fragment_50x10.yaml",
        ...
        root / "scripts" / "miyabi" / "run_9node_fragment_gpt2_wikitext2_50x10.pbs",
        root / "scripts" / "miyabi" / "run_9node_no_fragment_gpt2_wikitext2_50x10.pbs",
