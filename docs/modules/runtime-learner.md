...
learner 随后等待 exact receipt acknowledgement、drain 或 terminal，防止 authority ingest 无限落后。global adoption 只接受 current epoch latest chain；learner 不读 SQLite。terminal drain 发布 exact final cycle/update ack，hard crash 由 authority 记上界而不是伪造 stopped heartbeat。
