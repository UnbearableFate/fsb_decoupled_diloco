...
MODULE_SUMMARIES = {
    ...
    "fs_diloco.observability.logging_utils": "将进程事件、异常和运行证明写入 JSONL。",
    ...
    "fs_diloco.protocol.contributor": "定义 static 与 dynamic contributor fence 和 membership scope。",
    ...
    "fs_diloco.protocol.selection": "按持久服务历史确定性选择 contributor。",
    ...
    "fs_diloco.runtime.pbs_scheduler": "查询和提交 dynamic Learner 使用的 PBS 作业。",
    "fs_diloco.runtime.services": "汇集 Full Protocol 运行时组合的窄职责有状态服务。",
    "fs_diloco.runtime.services.dynamic_capacity": "持久化 dynamic capacity 观测并与 PBS launch 状态对账。",
    ...
    "fs_diloco.storage.leader_lease": "定义 leader lease 值对象和本地单调时钟安全边界。",
    "fs_diloco.storage.object_store": "按内容身份读取不可变 payload 对象。",
    ...
    "fs_diloco.storage.tensor_codec": "使用 Safetensors 编码和读取全局权重、更新向量与外层优化器状态。",
    ...
    "fs_diloco.tools.request_static_replacement": "发布替换 active static attempt 的显式 operator request。",
